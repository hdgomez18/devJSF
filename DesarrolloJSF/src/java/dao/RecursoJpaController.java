...
public class RecursoJpaController implements Serializable {
    ...
    public void create(Recurso recurso) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findRecurso(recurso.getReIsbn()) != null) {
